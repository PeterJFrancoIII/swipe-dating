...
export const GETFKD_ENTER_BODY =
  "You are entering Get Fk'd mode. Discovery starts within 1 mile. Your location may be exposed only if both of you match while both are in this mode. If another adult also has the mode on and is within Bluetooth range, your phone will sonar-ding and vibrate more warmly the closer you get. No exact distance or direction is shown. Matches and chats from this mode disappear when either of you leaves.";
