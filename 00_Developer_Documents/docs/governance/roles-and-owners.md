...
- The person approving security may not be the sole author of the reviewed cryptographic or attestation implementation.
...
- The adult-assurance, proximity, location, and anti-abuse owners must sign feature-specific evidence before real-user activation.
