...
| Doc | Purpose |
|---|---|
| `release-gates.md` | What blocks beta and production, including JavaScript, local persistence, BLE, location, marketplace, and anti-abuse gates |
...
| `roles-and-owners.md` | Named role placeholders, including local data custody |
